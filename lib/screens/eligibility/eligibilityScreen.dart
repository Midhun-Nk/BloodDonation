...
import 'package:flutter/material.dart';
  ...
  Navigator.of(context).pushReplacement(
    MaterialPageRoute(
      builder: (context) => const NavigationbarScreen(), // Navigate to HomeScreen
    ),
  );
}
          ...
          child: Column(
            children: [
              Stack(
                children: [
                   Image.asset(
                        'assets/images/content/circle.png',
                      ),
                      Padding(
                     ...
                     const    SizedBox(height: 50),
                          Padding(
                            ...
                            child: Text(
                              ...
                              style: TextStyle(
                                color: dark ? const Color.fromARGB(255, 0, 0, 0) : TColors.black,
                                fontSize: 18,
...
void _answerQuestion(String answer) {
  setState(() {
    ...
    if (currentQuestionIndex < questions.length - 1) {
      ...
      bool isEligible = answers.length == 4 && answers[0] == 'Yes' && answers.sublist(1).every((ans) => ans == 'No');
      updateEligibility(isEligible ? 'true' : 'false');
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            ...
            content: Text(
              isEligible ? "Congratulations! You are eligible to donate blood." : "Sorry, you are not eligible to donate blood.",
