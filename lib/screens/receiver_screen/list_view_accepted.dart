...
class ListViewAccepted extends StatelessWidget {
  const ListViewAccepted({super.key});
                ...
                child: Obx(() {
                  if (controller.isLoading.value) {
                    ...
                    return ListView.separated(
                        ...
                        itemCount: controller.userDataList2
                            .where((userData2) => (userData2['bloodGroup'] != 'Nill'))
                            .length,
                        itemBuilder: (_, index) {
                          // Filtered userDataList excluding items with blood group 'Nill'
                          final filteredUserDataList2 = controller.userDataList2
                              .where((userData2) => (userData2['bloodGroup'] != 'Nill'))
                              .toList();
                    
                          final bloodGroup =
                              controller.userDataList2[index]['bloodGroup'] ?? '';
                          final userID = controller.userDataList2[index]['id'] ?? '';
                          ...
                          final userData2 = filteredUserDataList2[index];
                          final imageURl = userData2['ProfilePicture'] == ''
                              ? TImages.user
                                            ...
                                            Expanded(
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  TextBlock(
                                                    title:
                                                        "${userData2['Gender']} (${userData2['Age']} Age) " ??
                                                            'Nill',
                                                    icons: Iconsax.user,
                                                  ),
                                                  const SizedBox(height: 8.0),
                                                  TextBlock(
                                                      title: "${userData2['Street']}",
                                                      icons: Iconsax.location_add),
                                                  const SizedBox(height: 8.0),
                                                  TextBlock(
                                                      title: userData2['City'],
                                                      icons: Iconsax.location),
                                                  const SizedBox(height: 8.0),
                                                  TextBlock(
                                                      title: userData2['PhoneNumber'] ??
                                                          'Nill',
                        ...
                        await controller.deleteconfrimed(userID);
